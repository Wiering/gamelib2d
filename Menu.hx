...
class Menu
{
	public static var KEY_UP     : Int =  flash.ui.Keyboard.UP;
	public static var KEY_DOWN   : Int =  flash.ui.Keyboard.DOWN;
	public static var KEY_SPACE  : Int =  flash.ui.Keyboard.SPACE;
	public static var KEY_ENTER  : Int =  flash.ui.Keyboard.ENTER;
	public static var KEY_ESCAPE : Int =  flash.ui.Keyboard.ESCAPE;
	...
	public function init (f: BMFont, x: Int, y: Int, ew: Int, eh: Int, pw: Int, bc: Int, sc: Int, ?sx: Float = 1.0, ?sy: Float = 1.0)
	{
		font = f;
		centerX = x;
		centerY = y;
	...
	public function draw ()
	{
		...
		if (! initialized)
		{
			...
			menuBmp.scaleX = scaleX;
			menuBmp.scaleY = scaleY;
