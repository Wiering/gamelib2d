...
class Status
{
	...
	public function new (name: String, value: Int, format: String, x: Int, y: Int, align: Int, ?inc: Int = 0, ?max: Int = 100)
	{
		this.METER_MAX = max;
		this.name = name;
		this.value = value;
	...
	public function draw ()
	{
		...
		else
		{
			...
			var s: String = Utils.formatStr (format, [v]);
			var t: String = s;
			for (i in 0...t.length)
				if (t.charAt (i) == " ")
					s = " " + s;
